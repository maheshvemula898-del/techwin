      ...
      <main className="flex-grow">
        {(page.sections || []).map((section, idx) => {
          switch (section.type) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto text-left">
                      {section.items?.map((item, iidx) => {
                        ...
                        return (
                          ...
                          >
                            <div className="w-10 h-10 rounded-none bg-[#e3e8ed] flex items-center justify-center mb-5 text-[#1e6fd9]">
                            ...
                            {item.link && (
                              <Link 
                                to={item.link} 
                                className="inline-flex items-center text-xs font-bold text-[#1e6fd9] hover:text-[#195fc0] hover:underline uppercase tracking-wider gap-1"
                              >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                      {section.items?.map((item, iidx) => (
                        <div key={iidx} className="text-center">
                          <div className="text-3xl md:text-4xl font-light text-[#1e6fd9] mb-2">
            ...
            case "cta":
              return (
                <section key={idx} className="py-16 md:py-20 bg-[#1e6fd9] text-white relative overflow-hidden">
