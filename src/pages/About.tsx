          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              {textContent.stats && textContent.stats.length > 0 && (
                <div className="absolute -bottom-4 -right-4 bg-[#1e6fd9] p-4 text-white rounded-none">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              ...
              >
                <div className="w-10 h-10 bg-neutral-100 flex items-center justify-center text-[#1e6fd9] mb-4 rounded-none">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="w-3 h-3 bg-[#1e6fd9] shrink-0 mt-2 rounded-none" />
                <div className="p-6 border border-neutral-200 bg-white flex-1 hover:border-neutral-300 transition-colors rounded-none">
                  <div className="text-sm font-semibold text-[#1e6fd9] mb-2">{milestone.year}</div>
