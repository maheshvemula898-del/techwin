...
const Careers = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitToFormspree(submission);
      toast({
        title: "Application Submitted",
        description: "Thank you for applying. We will review your application and get back to you soon.",
      });
      setFormData({ name: "", email: "", phone: "", location: "", region: "", resume: null });
      setIsDialogOpen(false);
    } catch (error) {
      console.error("Formspree submission failed:", error);
      toast({
        title: "Form temporarily unavailable",
        description: "Please email your application to info@techwensys.com.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-neutral-900 selection:bg-[#2583ff] selection:text-white">
      ...
      <PageHero 
        ...
        backgroundImage="/careers_hero.jpg"
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="border-b border-neutral-200 pb-4 mb-12 text-left">
            {textContent.sectionTag && (
              <span className="text-xs font-bold tracking-wider text-[#1e6fd9] uppercase block mb-1">
                {textContent.sectionTag}
              </span>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {benefits.map((benefit, index) => {
              const Icon = getLucideIcon(benefit.iconName);
              return (
                <div
                  key={benefit.title}
                ...
                >
                  <div className="space-y-4">
                    {/* Icon */}
                    <div className="w-10 h-10 bg-neutral-100 flex items-center justify-center text-[#1e6fd9] rounded-none">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto rounded-none">
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data" className="mt-6 space-y-6 text-left">
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <Button
                type="submit"
                className="bg-[#1e6fd9] hover:bg-[#195fc0] text-white rounded-none"
              >
                Submit
              </Button>
            </div>
