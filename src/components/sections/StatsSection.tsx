...
const stats = [
  { 
    ...
    label: "Core Services",
    icon: Briefcase,
    description: "Comprehensive enterprise IT services"
  },
  { 
    value: 100, 
    suffix: "%", 
  ...
  { 
    ...
    label: "Email Contact",
    icon: Mail,
    description: "info@techwensys.com"
  },
];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-primary-foreground/70 max-w-2xl mx-auto">
            Delivering secure, scalable enterprise technology services with unwavering dedication to your success
          </p>
        </motion.div>
